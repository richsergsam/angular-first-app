...
export class PizzaService {
  private pizzas = [
    ...
    },
    {
      ...
      ingridients:['моцарелла', 'томаты', 'итальянские травы', 'томатный соус'],
      weight: 700,
      cost: 329
    },
    {
      ...
      imageURL: 'https://dodopizza-a.akamaihd.net/static/Img/Products/26fa2948b6c74113afb9d09a3262fc26_292x292.jpeg',
    ...
    },
    {
      id: 3,
      title: 'Овощи и грибы',
      imageURL: 'https://dodopizza-a.akamaihd.net/static/Img/Products/7a497170e99a435f8535f33c3ebaddc3_292x292.jpeg',
      description: 'Шампиньоны, томаты, сладкий перец, красный лук, маслины, кубики брынзы, моцарелла, томатный соус, итальянские травы',
      ingridients:['шампиньоны','томаты', 'сладкий перец', 'красный лук', 'маслины', 'брынза', 'моцарелла', 'томатный соус', 'итальянские травы'],
      weight: 500,
      cost: 379
    },
    {
    ...
    },
    {
      ...
      ingridients:['острый цыпленок', 'острый перец халапеньо', 'соус сальса', 'томаты', 'сладкий перец', 'красный лук', 'моцарелла', 'томатный соус'],
      weight: 650,
      cost: 429
    },
  ];
